...
eb init rssbox --platform ruby-4.0 --keyname id_rsa
...
aws elasticbeanstalk update-environment --region us-west-2 --environment-name rssbox --solution-stack-name "64bit Amazon Linux 2023 v4.12.1 running Ruby 4.0"
```
